...
//import com.cec.videoplayer.dto.CourseDto;
//import com.cec.videoplayer.dto.DeviceDto;
//import com.cec.videoplayer.dto.DeviceOperationDto;
//import com.cec.videoplayer.dto.DeviceReleDto;
//import com.cec.videoplayer.dto.OrgnizationDto;
import com.cec.videoplayer.dto.UserDto;
//import com.cec.videoplayer.model.DeviceCourse;
//import com.cec.videoplayer.model.DeviceInfo;
//import com.cec.videoplayer.model.DeviceOperation;
//import com.cec.videoplayer.model.DeviceRele;
//import com.cec.videoplayer.model.SpOrgnization;
import com.cec.videoplayer.model.User;
...
//    }
//
//    public static DeviceOperation toOperation(DeviceOperationDto operationDto) {
//        DeviceOperation operation = new DeviceOperation();
//        operation.setmId(operationDto.getId());
//        operation.setName(operationDto.getName());
//        operation.setTime(operationDto.getTime());
//        operation.setContent(operationDto.getContent());
//        operation.setDeviceId(operationDto.getDeviceId());
//        operation.setValid(operationDto.isValid());
//        return operation;
//    }
//
//    public static DeviceOperationDto toOperationDto(DeviceOperation operation) {
//        DeviceOperationDto operationDto = new DeviceOperationDto();
//        operationDto.setId(operation.getmId());
//        operationDto.setName(operation.getName());
//        operationDto.setTime(operation.getTime());
//        operationDto.setContent(operation.getContent());
//        operationDto.setDeviceId(operation.getDeviceId());
//        operationDto.setValid(operation.isValid());
//        return operationDto;
//    }
