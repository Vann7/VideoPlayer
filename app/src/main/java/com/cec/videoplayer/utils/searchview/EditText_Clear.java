...
public class EditText_Clear extends android.support.v7.widget.AppCompatEditText {
    ...
    private void init() {
        ...
        clearDrawable = getResources().getDrawable(R.mipmap.text_del2);
        searchDrawable = getResources().getDrawable(R.mipmap.ic_search2);

//        setCompoundDrawablesWithIntrinsicBounds(searchDrawable, null,null, null);

//        setCompoundDrawables(clearDrawable,null,null,null);
