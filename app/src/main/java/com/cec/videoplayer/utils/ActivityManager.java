...
public class ActivityManager {
    ...
    private static final List<Activity> activities = new LinkedList<Activity>();

    private static ActivityManager manager;

    private static boolean isExist = false;// activity 存在标志
     ...
     * @return
     */
    public static boolean add(final Activity activity) {
...
//    }
     ...
     * @param activity
     */
    private static void popActivity(final Activity activity) {
     ...
     * 是否存在指定的Activity
     * */
    public static boolean isExistActivity(final Class<? extends Activity> targetclazz) {
        Activity activity;
     ...
     * @return
     */
    public static boolean isBottomActivity(final Activity activity) {
